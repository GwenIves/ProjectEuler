...
void bignum_print (const bignum_t *);

bool bignum_is_palindrome (const bignum_t *);

int bignum_cmp (const bignum_t *, const bignum_t *);
bool bignum_is_digit (const bignum_t *, int);

int bignum_digits_sum (const bignum_t *);

bignum_t * bignum_mult_bignum (const bignum_t *, const bignum_t *);
bignum_t * bignum_mult_int (const bignum_t *, int);
bignum_t * bignum_mult_bignum_to (bignum_t *, bignum_t *);
bignum_t * bignum_mult_int_to (bignum_t *, int);

bignum_t * bignum_add (const bignum_t *, const bignum_t *);
