...
assert "$(../src/138_triangles 2)" 322 $LINENO
assert "$(../src/138_triangles 12)" 1118049290473932 $LINENO $REFERENCE
...
assert "$(../src/158_strings 26)" 409511334375 $LINENO $REFERENCE
