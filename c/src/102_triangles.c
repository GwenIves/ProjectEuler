...
static bool contains_origin (triangle_t *);
...
static bool contains_origin (triangle_t * t) {
	point_t * a = &t->a;
	point_t * b = &t->b;
	point_t * c = &t->c;
...
static bool verify (point_t * a, point_t * b, point_t * c) {
...
static bool in_one_halfplane (line_equation_t * eq, point_t * a, point_t * b) {
