...
static long get_run_sum (char, size_t, int, const int *, size_t);
static void fill_candidate (char *, char, size_t, const int *, size_t);
...
static long get_run_sum (char run_digit, size_t run_len, int N, const int * primes, size_t primes_count) {
	long sum = 0;
...
static void fill_candidate (char * candidate, char run_digit, size_t run_len, const int * rest_digits, size_t rest_len) {
	size_t i = 0;
	size_t j = 0;
